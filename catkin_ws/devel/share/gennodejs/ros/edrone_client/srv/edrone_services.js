...
class edrone_servicesRequest {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type edrone_servicesRequest
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type edrone_servicesRequest
    let len;
    let data = new edrone_servicesRequest(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new edrone_servicesRequest(null);
...
class edrone_servicesResponse {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type edrone_servicesResponse
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type edrone_servicesResponse
    let len;
    let data = new edrone_servicesResponse(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new edrone_servicesResponse(null);
...
module.exports = {
  Request: edrone_servicesRequest,
  Response: edrone_servicesResponse,
  md5sum() { return '4694157b8edbc1fcf473057bcd528de1'; },
  datatype() { return 'edrone_client/edrone_services'; }
};
