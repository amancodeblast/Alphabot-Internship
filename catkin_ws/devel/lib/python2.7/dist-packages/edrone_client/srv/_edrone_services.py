...
"""autogenerated by genpy from edrone_client/edrone_servicesRequest.msg. Do not edit."""
import codecs
import sys
...
class edrone_servicesRequest(genpy.Message):
  _md5sum = "f8dca44e14493750e1a83a8276b2d8e4"
  _type = "edrone_client/edrone_servicesRequest"
...
"""
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(edrone_servicesRequest, self).__init__(*args, **kwds)
...
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from edrone_client/edrone_servicesResponse.msg. Do not edit."""
import codecs
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
...
class edrone_servicesResponse(genpy.Message):
  _md5sum = "c7a7b135453cda7e71490802dabf7edd"
  _type = "edrone_client/edrone_servicesResponse"
  _has_header = False  # flag to mark the presence of a Header object
  _full_text = """#response
...
"""
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(edrone_servicesResponse, self).__init__(*args, **kwds)
      # message fields cannot be None, assign default values for those that are
...
def _get_struct_8i():
    ...
    return _struct_8i
class edrone_services(object):
  _type          = 'edrone_client/edrone_services'
  _md5sum = '4694157b8edbc1fcf473057bcd528de1'
  _request_class  = edrone_servicesRequest
  _response_class = edrone_servicesResponse
