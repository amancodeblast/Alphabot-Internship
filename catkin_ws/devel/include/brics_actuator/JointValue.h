...
bool operator==(const ::brics_actuator::JointValue_<ContainerAllocator1> & lhs, const ::brics_actuator::JointValue_<ContainerAllocator2> & rhs)
{
  return lhs.timeStamp == rhs.timeStamp &&
    lhs.joint_uri == rhs.joint_uri &&
    lhs.unit == rhs.unit &&
    lhs.value == rhs.value;
}
