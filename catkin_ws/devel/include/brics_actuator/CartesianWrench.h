...
bool operator==(const ::brics_actuator::CartesianWrench_<ContainerAllocator1> & lhs, const ::brics_actuator::CartesianWrench_<ContainerAllocator2> & rhs)
{
  return lhs.timeStamp == rhs.timeStamp &&
    lhs.poisonStamp == rhs.poisonStamp &&
    lhs.base_frame_uri == rhs.base_frame_uri &&
    lhs.target_frame_uri == rhs.target_frame_uri &&
    lhs.force == rhs.force &&
