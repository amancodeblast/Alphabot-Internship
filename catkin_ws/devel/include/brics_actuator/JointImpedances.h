...
bool operator==(const ::brics_actuator::JointImpedances_<ContainerAllocator1> & lhs, const ::brics_actuator::JointImpedances_<ContainerAllocator2> & rhs)
{
  return lhs.poisonStamp == rhs.poisonStamp &&
    lhs.dampings == rhs.dampings &&
    lhs.stiffnesses == rhs.stiffnesses;
}
